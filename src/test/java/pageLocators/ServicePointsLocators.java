...
public class ServicePointsLocators {
    ...
    //  public final By POSTI_POINTS = By.cssSelector("div.Component-root-0-1-54");
     //public final By POSTI_POINTS = By.xpath("//div[@class='Component-root-0-1-54']");
    // public final By POSTI_POINTS2 = By.cssSelector("div.Component-root-0-1-54.Component-root-0-1-57");
    public final By POSTI_POINTS2 = By.cssSelector("svg.sc-2274bq-0.bEoFZP");
